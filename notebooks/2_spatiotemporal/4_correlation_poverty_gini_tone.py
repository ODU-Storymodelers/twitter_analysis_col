...
def get_correlation_poverty_gini_tone(tone):
    # Load tone data
    ...
    correlation, p_value = stats.pearsonr(df_merged['poverty_rate_per_100000'], df_merged['proportion_per_100000_' + tone])

    print("================================================")
    print(f"1. Correlation between {tone} tone and poverty rate: {correlation:.3f}")
    ...
    if p_value < alpha:
        ...
        print(f"correlation between {tone} tone and poverty rate.")

    # Calculate correlation coefficient and p-value for (2) extreme poverty rate:
    correlation, p_value = stats.pearsonr(df_merged['extreme_poverty_rate_per_100000'], df_merged['proportion_per_100000_' + tone])

    print("--------------------------------")
    print(f"2. Correlation between {tone} tone and extreme poverty rate: {correlation:.3f}")
    print(f"P-value: {p_value:.3f}")
    ...
    if p_value < alpha:
        ...
        print(f"\nThe p-value ({p_value:.3f}) is greater than {alpha}, suggesting that")
        print(f"there is not enough evidence to conclude a statistically significant")
        print(f"correlation between {tone} tone and extreme poverty rate.")

    # Calculate correlation coefficient and p-value for (3) Gini index:
    correlation, p_value = stats.pearsonr(df_merged['gini_coefficient_per_100000'], df_merged['proportion_per_100000_' + tone])

    print("--------------------------------")
    print(f"3. Correlation between {tone} tone and Gini index: {correlation:.3f}")
    print(f"P-value: {p_value:.3f}")
    ...
    if p_value < alpha:
        ...
        print(f"\nThe p-value ({p_value:.3f}) is greater than {alpha}, suggesting that")
        print(f"there is not enough evidence to conclude a statistically significant")
        print(f"correlation between {tone} tone and Gini index.")
    print("================================================")
    return correlation, p_value


# Run the function for each tone
get_correlation_poverty_gini_tone('negative')
get_correlation_poverty_gini_tone('neutral')
get_correlation_poverty_gini_tone('positive')