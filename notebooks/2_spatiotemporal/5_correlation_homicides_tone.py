...
def get_correlation_homicides_tone(tone):   
    # Load tone data
    ...
    correlation, p_value = stats.pearsonr(df_merged['homicides_rate_per_100000'], df_merged['proportion_per_100000_' + tone])

    print("================================================")
    print(f"1. Correlation between {tone} tone and homicide rate: {correlation:.3f}")
    ...
    if p_value < alpha:
        ...
        print(f"correlation between {tone} tone and homicide rate.")
    print("================================================")
    return correlation, p_value


# Run the function for each tone
get_correlation_homicides_tone('negative')
get_correlation_homicides_tone('neutral')
get_correlation_homicides_tone('positive')