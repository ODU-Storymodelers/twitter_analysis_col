...
def eq_division(data, categories = None, n_sample = None, cats_col_name = 'frustration'):
    """
        Divide a dataframe into a equal number of samples for each category.

        Parameters
            data:           The dataframe to be split.
            categories:     The list of the categories to be used.
            n_sample:       The number of observations per categorie.
...
def predict_ents(dataframe, model, text_col_name = 'paragraph'):
    """
...
def text_clean(text):
    """
        Cleans the text deleting unnecesary symbols, accents and emojis
